...
<head>
  ...
  <style>
    ...
    .college-header .badges { margin-top: 8px; }
    ...
    .review-card form { margin-top:10px; }
    .review-card .delete { padding:8px 14px; }
    ...
    .add-btn:hover, .download-btn:hover { background: #2980b9; }
...
<body>
  ...
  <div class="main">
    ...
    <div class="sidebar">
      <h2>Colorido</h2>
      <h3>ADMIN PANEL</h3>
      <a href="dashboard.php?page=events">📅 Manage Events</a>
      <a href="dashboard.php?page=registrations">📋 View Registrations</a>
      <a href="dashboard.php?page=reviews">💬 View Reviews</a>
    ...
    <div class="content">
      ...
      <?php if ($page == "events") { ?>
        ...
        <table>
          ...
          <?php } } else { ?>
            <tr><td colspan="10">No events available</td></tr>
          <?php } ?>
        </table>
      ...
      <?php } elseif ($page == "registrations") { ?>
        ...
        <!-- Download CSV button -->
        <a href="download_registrations.php" class="download-btn">📥 Download Student Registrations (CSV)</a>
